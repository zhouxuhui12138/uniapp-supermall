...
function initData(vueOptions, context) {
  ...
  if (typeof data === 'function') {
    try {
      ...
      if (Object({"NODE_ENV":"development","VUE_APP_NAME":"uniapp-supermall","VUE_APP_PLATFORM":"mp-weixin","BASE_URL":"/"}).VUE_APP_DEBUG) {
...
/***/ 12:
/*!***************************************************************!*\
  !*** C:/Users/周旭辉/Desktop/前端/uniapp-supermall/store/index.js ***!
  \***************************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {
...
var _vuexPersistedstate = _interopRequireDefault(__webpack_require__(/*! vuex-persistedstate */ 14));function _interopRequireDefault(obj) {return obj && obj.__esModule ? obj : { default: obj };} //数据持久化插件
...
var store = new _vuex.default.Store({
  ...
  getters: {
    ...
    // 是否全选
    cartListAllSelected: function cartListAllSelected(state) {
  ...
  mutations: {
    ...
    // 添加购物车数量
    addCartCount: function addCartCount(state, iid) {
      var cart = state.cartList.find(function (item) {return item.iid === iid;});
      cart.count++;
    },
    // 改变选中状态
    cartSelectedChange: function cartSelectedChange(state, payload) {
      if (payload.iid) {
        // 单选
        var cart = state.cartList.find(function (item) {return item.iid === payload.iid;});
        cart.selected = payload.selected;
      } else {
        // 全选
        state.cartList.map(function (item) {return item.selected = payload;});
      }
    } },

  actions: {
    addCart: function addCart(ctx, payload) {
      return new Promise(function (resovle, reject) {
        var cart = ctx.state.cartList.find(function (item) {return item.iid === payload.iid;});
        if (!cart) {
          // 没有则添加
          payload.count = 1;
...
/***/ 14:
/*!****************************************************************************************************************!*\
  !*** C:/Users/周旭辉/Desktop/前端/uniapp-supermall/node_modules/vuex-persistedstate/dist/vuex-persistedstate.es.js ***!
  \****************************************************************************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {
...
/***/ 147:
/*!*****************************************************************************************************************!*\
  !*** C:/Users/周旭辉/Desktop/前端/uniapp-supermall/uni_modules/uni-goods-nav/components/uni-goods-nav/i18n/index.js ***!
  \*****************************************************************************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {
...
/***/ 148:
/*!****************************************************************************************************************!*\
  !*** C:/Users/周旭辉/Desktop/前端/uniapp-supermall/uni_modules/uni-goods-nav/components/uni-goods-nav/i18n/en.json ***!
  \****************************************************************************************************************/
...
/***/ 149:
/*!*********************************************************************************************************************!*\
  !*** C:/Users/周旭辉/Desktop/前端/uniapp-supermall/uni_modules/uni-goods-nav/components/uni-goods-nav/i18n/zh-Hans.json ***!
  \*********************************************************************************************************************/
/*! exports provided: uni-goods-nav.options.shop, uni-goods-nav.options.cart, uni-goods-nav.buttonGroup.addToCart, uni-goods-nav.buttonGroup.buyNow, default */
/***/ (function(module) {
...
/***/ 150:
/*!*********************************************************************************************************************!*\
  !*** C:/Users/周旭辉/Desktop/前端/uniapp-supermall/uni_modules/uni-goods-nav/components/uni-goods-nav/i18n/zh-Hant.json ***!
  \*********************************************************************************************************************/
/*! exports provided: uni-goods-nav.options.shop, uni-goods-nav.options.cart, uni-goods-nav.buttonGroup.addToCart, uni-goods-nav.buttonGroup.buyNow, default */
/***/ (function(module) {
...
/***/ 200:
/*!********************************************************************************!*\
  !*** C:/Users/周旭辉/Desktop/前端/uniapp-supermall/node_modules/dayjs/dayjs.min.js ***!
  \********************************************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {
...
/***/ 222:
/*!****************************************************************************************************!*\
  !*** C:/Users/周旭辉/Desktop/前端/uniapp-supermall/uni_modules/uni-icons/components/uni-icons/icons.js ***!
  \****************************************************************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {
...
/***/ 24:
/*!*************************************************************!*\
  !*** C:/Users/周旭辉/Desktop/前端/uniapp-supermall/api/index.js ***!
  \*************************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {

"use strict";
Object.defineProperty(exports, "__esModule", { value: true });exports.GetSubCategory = exports.GetCategory = exports.GetRecommend = exports.GetGoodsDetail = exports.GetGoodsList = exports.GetHomeDate = void 0;var _request = _interopRequireDefault(__webpack_require__(/*! ../uitls/request.js */ 25));function _interopRequireDefault(obj) {return obj && obj.__esModule ? obj : { default: obj };}

// 请求首页数据
var GetHomeDate = function GetHomeDate() {
...
// 请求商品列表
exports.GetHomeDate = GetHomeDate;var GetGoodsList = function GetGoodsList(_ref) {var type = _ref.type,page = _ref.page;
  return (0, _request.default)({
    url: "/home/data",
    data: {
      type: type,
...
// 根据商品id查询商品详情数据
exports.GetGoodsList = GetGoodsList;var GetGoodsDetail = function GetGoodsDetail(id) {
  return (0, _request.default)({
    url: "/detail?iid=".concat(id) });

};

// 获取商品详情推荐数据
exports.GetGoodsDetail = GetGoodsDetail;var GetRecommend = function GetRecommend() {
  return (0, _request.default)({
    url: "/recommend" });
...
// 获取分类数据
exports.GetRecommend = GetRecommend;var GetCategory = function GetCategory() {
  return (0, _request.default)({
    url: "/category" });
...
// 根据id获取分类详情
exports.GetCategory = GetCategory;var GetSubCategory = function GetSubCategory(id) {
  return (0, _request.default)({
    url: "/subcategory?maitKey=".concat(id) });
...
/***/ 25:
/*!*****************************************************************!*\
  !*** C:/Users/周旭辉/Desktop/前端/uniapp-supermall/uitls/request.js ***!
  \*****************************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {

"use strict";
/* WEBPACK VAR INJECTION */(function(uni) {Object.defineProperty(exports, "__esModule", { value: true });exports.default = void 0;var baseURL = "http://152.136.185.210:7878/api/hy66";

var myRequest = function myRequest(config) {
  return new Promise(function (resovle, reject) {
    uni.request({
      // url
...
/***/ 5:
/*!***********************************************************!*\
  !*** C:/Users/周旭辉/Desktop/前端/uniapp-supermall/pages.json ***!
  \***********************************************************/
/*! no static exports found */
/***/ (function(module, exports) {
